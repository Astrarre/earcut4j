...
public class Test01 {
    ...
    public void simplePolygon() {
        List<Integer> triangles = Earcut.earcut(new float[] { 10,0, 0,50, 60,60, 70,10 }, null, 2);
        // returns [1,0,3, 3,2,1]
    ...
    public void poluygonWith3DCoords() {
        List<Integer> triangles = Earcut.earcut(new float[] { 10, 0, 1, 0, 50, 2, 60, 60, 3, 70, 10, 4 }, null, 3);
        // [1,0,3, 3,2,1]
        Assert.assertArrayEquals(new Object[] {1,0,3, 3,2,1}, triangles.toArray());
    }
    ...
    @Test
    public void issue2() {
        List<Integer> triangles = Earcut.earcut(new float[] { 5400.0f, 200.0f, 0.0f, 5400.0f, 200.0f, 5000.0f, 5400.0f, 0.0f, 5000.0f, 5400.0f, 0.0f, 0.0f }, null, 3);
